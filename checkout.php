  ...
  <style>
    * {
    ...
    .sukses-glow .ring-2 {
      width: 126px;
      height: 126px;
      background: rgba(42, 133, 255, 0.11);
    }

    .sukses-glow .ring-3 {
      width: 96px;
      height: 96px;
      background: rgba(42, 133, 255, 0.16);
    }
    ...
    .pay-item.selected {
      border-color: #2a85ff;
      box-shadow: 0 0 0 3px rgba(42, 133, 255, 0.12);
    }
    ...
    .btn-bayar .bayar-label {
      font-size: 15px;
      font-weight: 800;
      display: block;
    }

    .btn-bayar .bayar-total {
      font-size: 13px;
      font-weight: 600;
      opacity: 0.85;
      display: block;
