          ...
          <div class="log-list">
            <?php if ($status === 'selesai'): ?>
              <div class="log-item log-current">
                ...
                <div>
                  <div class="log-text">Paket telah diterima oleh penerima</div>
            ...
            <?php if (in_array($status, ['dikirim', 'selesai'])): ?>
              <div class="log-item <?= $status === 'dikirim' ? 'log-current' : '' ?>">
                <div class="log-dot"></div>
                <div>
                  <div class="log-text">Paket sedang dalam pengiriman</div>
                  <div class="log-time"><?= $created ?></div>
                </div>
              </div>
            <?php endif; ?>
            <div class="log-item <?= $status === 'diproses' ? 'log-current' : '' ?>">
              <div class="log-dot"></div>
              <div>
                <div class="log-text">Pesanan sedang dikemas oleh penjual</div>
                <div class="log-time"><?= $created ?></div>
              </div>
            </div>
            <div class="log-item">
              <div class="log-dot"></div>
              <div>
                <div class="log-text">Pembayaran berhasil dikonfirmasi</div>
                <div class="log-time"><?= $created ?></div>
              </div>
            </div>
            <div class="log-item">
              <div class="log-dot"></div>
              <div>
                <div class="log-text">Pesanan berhasil dibuat</div>
                <div class="log-time"><?= $created ?></div>
              </div>
            </div>
          </div>
