...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Helvetica Neue', Arial, sans-serif; }
    body { background: #f8fafc; color: #0d1c2e; }
    ...
    .alert { padding:14px; border-radius:10px; font-size:14px; font-weight:600; margin-bottom:20px; }
    .alert-success { background:#e6f9f0; color:#10b981; border-left:4px solid #10b981; }
    .alert-error   { background:#fff0f0; color:#e53935; border-left:4px solid #e53935; }
    .alert-info    { background:#eff6ff; color:#3b82f6; border-left:4px solid #3b82f6; }
    ...
    .item-header img {
      width: 64px; height: 64px; border-radius: 10px; object-fit: cover; background: #f1f5f9;
    }
    .item-title { font-size: 15px; font-weight: 700; margin-bottom: 4px; }
    .item-price { font-size: 13px; color: #64748b; font-weight: 600; }

    .rating-wrap { margin-bottom: 20px; }
    .rating-label { font-size: 14px; font-weight: 700; margin-bottom: 10px; display: block; }
    .stars { display: flex; gap: 8px; flex-direction: row-reverse; justify-content: flex-end; }
    
    .stars input { display: none; }
    .stars label {
      font-size: 28px; color: #cbd5e1; cursor: pointer; transition: 0.2s;
    }
    .stars label:hover,
    ...
    .form-group textarea:focus { border-color: #2a85ff; }
